...
include "begol.php";
echo color("green"," +_+ +_+ +_+ +_+ +_+ +_+ +_+\n");
echo color("red","| ROOT FIKOM UMI|\n");
echo color("yellow","| Auto Claim Voucher  |\n");
echo color("red","| AHMAD FAISAL|\n");
echo color("yellow","| IG AHMAD_FAISAL199        |\n");
echo color("red","| DI SINI ADA GOJEK DI SINI ADA VOUCHER     |\n");
echo color("yellow", "| Time    :".date('[d-m-Y] [H:i:s]')."   |\n");
echo color("blue"," +_+ +_+ +_+ +_+ +_+ +_+ +_+ +_+\n");
// function change(){
        $nama = nama();
